                ...
                <div class="dropdown ms-sm-3 header-item topbar-user">
                    <button type="button" class="btn" id="page-header-user-dropdown" data-bs-toggle="dropdown" aria-haspopup="true" aria-expanded="false">
                        <span class="d-flex align-items-center">
                            ...
                            //var_dump($user);exit;
                            ?>
                            <img class="rounded-circle header-profile-user" src="<?php (!is_null($user['image'])) ? print('uploads/avater/' . $user['image']) : print('assets/images/users/avatar-1.jpg') ?>" alt="Header Avatar">
                    ...
                    <div class="dropdown-menu dropdown-menu-end">
                        ...
                        <a href="profile.php" class="dropdown-item" href="pages-profile.html"><i class="mdi mdi-account-circle text-muted fs-16 align-middle me-1"></i> <span class="align-middle">Profile</span></a>

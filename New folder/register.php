...
if (count($_POST) > 0) {
    ...
    $stmt = $pdo->prepare("INSERT INTO users (email, name, password, created_at) VALUES (:email, :username, :password, :created_at)");
    $stmt->bindParam(':email', $inputData['email']);
    $stmt->bindParam(':username', $inputData['username']);
    $stmt->bindParam(':password', $inputData['password']);
    // $stmt->bindParam(':batch', $inputData['batch']);
    $stmt->bindParam(':created_at', $inputData['created_at']);
                        ...
                        <div class="card mt-4 card-bg-fill">
                            ...
                            <div class="card-body p-4">
                                <div class="text-center mt-2">
                                    ...
                                    <p class="text-muted">Get your free Project Hub account now</p>
                                </div>
                                <div class="p-2 mt-4">
